...
type player = {name : string; position : nat; saved_co2_kilos : nat; last_dice_roll : timestamp; current_step : nat; supported_fields : supported_fields}
...
type global_storage = fields_storage * players_storage * step
